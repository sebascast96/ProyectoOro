                        ...
                        <div class="col-lg-4">
                            <div class="card card-chart">
                                <div class="card-header">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-round btn-outline-default dropdown-toggle btn-simple btn-icon no-caret dropdown-toggle"
                                ...
                                <div class="card-body">
                                    ...
                                    <script src="{{ asset('js/grafica1.js') }}"></script>
                                    {{-- </div> --}}
                                </div>
                ...
                <footer class="footer">
                    <div class=" container-fluid ">
                        ...
                        <div class="copyright" id="copyright">
                            ...
                            </script>, Designed and coded by <a href="https://www.creative-tim.com"
                                target="_blank">Monologic Solutions</a>.
                        </div>
                    </div>
                </footer>
            </div>
    ...
    <script>
        ...
        $(window).resize(function() {
            ...
            if ($('.full-screen-map').length == 0 && $('.bd-docs').length == 0) {
                ...
                } else if ($navbar.hasClass('navbar-transparent') && $(window).width() < 991 && isExpanded !=
                    "false") {
